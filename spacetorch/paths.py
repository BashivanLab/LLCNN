...
_base_fs = Path("/lustre03/project/6057362/xinyuq/kernel_avpool/data")
...
DEFAULT_IMAGENET_VAL_DIR = IMAGENET_DIR
RWAVE_CONTAINER_PATH = DS_DIR / "imagenet" ##
SHAPE_PATH = DS_DIR /"shape"
