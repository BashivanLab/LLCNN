...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, planes, pool_type, max_num_pools, noise_std, kap_kernelsize=3, num_classes=1000, 
        ...
        self.layer1 = self._make_layer(block, planes[0], layers[0], #attention
                                       pool_type=pool_type, max_num_pools=max_num_pools, noise_std=noise_std, kap_kernelsize=kap_kernelsize, output_size=56, continuous=continuous, local_conv=local_conv, a=None)  # , local_conv=True, output_size=54
